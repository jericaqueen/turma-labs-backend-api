...
def load_training_materials():
    ...
    try:
        ...
        if os.path.exists(excel_path):
            ...
            print(f"Successfully loaded {len(training_materials_db)} training materials from Excel")
        else:
            print("Excel file not found, using default materials")
            
    except Exception as e:
        print(f"Error loading training materials: {str(e)}")
        # Keep existing hardcoded materials as fallback
